...
export default {
  ...
  links: [
    ...
    {
      href: 'https://alifd.alicdn.com/npm/@alilc/lowcode-engine@1.0.6/dist/css/engine-core.css',
      rel: 'stylesheet'
    },
    {
  ...
  scripts: [
    ...
    'https://alifd.alicdn.com/npm/@alilc/lowcode-engine@1.0.9/dist/js/engine-core.js',
